 ...
 * @author st67017
 */
public class CanvasEventUprava extends Application {
...
//        });
    ...
    public void handle(ActionEvent t) {
        ...
        FileChooser.ExtensionFilter extFilt = new FileChooser.ExtensionFilter("png files (*.png)", "*.png");
        ...
        if (file != null) {
            try {
                WritableImage wrImg = new WritableImage(canvasWidth, canvasHeight);
                canvas.snapshot(null,wrImg);
                
                RenderedImage renImg = SwingFXUtils.fromFXImage(wrImg, null);
                ImageIO.write(renImg, "png", file);
